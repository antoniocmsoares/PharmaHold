...
public class PharmaHold {
    public static Prescription pres1 = new Prescription(new int[] {01,01,2026},new int[] {02,01,2026},PrescriptionType.COMMON, DoctorNames.ANA_SANTOS);
    public static Prescription pres2 = new Prescription(new int[] {01,01,2026},new int[] {02,01,2026},PrescriptionType.COMMON, DoctorNames.ARTUR_SOUSA);
