...
public class PharmaHold {
    ...
    public static void main(String[] args) {
        ...
        // PRESCRIPTIONS
        Prescription.addPrescription(new int[]{1, 1, 2026}, new int[]{2, 5, 2026}, PrescriptionType.COMMON, "doctor1");
        Prescription.addPrescription(new int[]{4, 2, 2026}, new int[]{12, 5, 2026}, PrescriptionType.COMMON, "doctor2");
        Prescription.addPrescription(new int[]{7, 2, 2026}, new int[]{22, 6, 2026}, PrescriptionType.COMMON, "doctor3");
        ...
        Client.getUserById(2).addOrders(order2);
        Client.getUserById(3).addOrders(order3);
        ...
        while (userChoice != 0) {
            if (!isLoggedIn) { // used to be while, in case of error
                ...
                switch (userChoice) {
                    ...
                    default: {
                        System.out.println("Please use the numbers displayed on the buttons");
                        break;
                    }
                }
                // logged menu
                        ...
                        case 2: {
                            ...
                            if (loggedUser instanceof Client) {
                                if (loggedClient.getOrders().isEmpty()) {
                                    Interface.drawTitle("No orders linked to your user.",0);
                                }else {
